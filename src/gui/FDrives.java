...
public class FDrives extends javax.swing.JDialog {
    ...
    private final String image8Ext[] = {"8sd"};
    private final String image5Ext[] = {"z256"};
    private final ExtendedFileFilter image8Flt = new ExtendedFileFilter
            ("8 inch floppy image",image8Ext);
    private final ExtendedFileFilter image5Flt = new ExtendedFileFilter
            ("5 1/4 inch floppy image",image5Ext);
    ...
    public void showDialog(Vzlet machine) {
        
        m = machine;
//       wd = m.getWDC();
//       wap = m.getWAP();
        dir = new File(m.getConfig().getMyPath());
        int use = 0;//wd.isInUse();
/*        
...
//        wd.ejectImage(num);
    ...
    private void newImage(int num, String title, JTextField t) {
        Random r=new Random();
        String fn = String.format("new-%04X.", r.nextInt(0x10000));
        RandomAccessFile f;
        byte b[];
